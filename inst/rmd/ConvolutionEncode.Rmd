...
arrow.color.matrix <- matrix(rep(NA,matrix.length), ncol = num.states)
s <- 0
...
for (s in 0:(num.states-1)) {
  color.frames.0 <- which(arrow.color.matrix[,s+1] == 0) + 1
  color.frames.0 <- paste(color.frames.0, collapse = ",")
  color.frames.0 <- if(color.frames.0 == "") 0 else color.frames.0
  color.frames.1 <- which(arrow.color.matrix[,s+1] == 1) + 1
  color.frames.1 <- paste(color.frames.1, collapse = ",")
