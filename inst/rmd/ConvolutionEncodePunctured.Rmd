---
title: "Faltungskode Kodierung mit Punktierung"
...
\begin{tabular}{c c c c}
  \visible<1-> {Zustand & input & output & Folgezustand\\ \hline}
  `r encode.table`
\end{tabular}
\end{center}
\visible<`r length(message)+1`> {output: (`r ifelse(params$code >= 0, 0, 1)`)}
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
\begin{center}
