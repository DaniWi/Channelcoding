...
for(i in 1:nrow(message.matrix)){
  ...
  data.poly <- vecToPoly(message.matrix[i,])
  datastar.poly <- vecToPoly(c(message.matrix[i,],rep(0,rest.length)))
  rest.poly <- vecToPoly(code.matrix[i,][1:rest.length])
  code.poly <- vecToPoly(code.matrix[i,])
