---
title: "Faltungskode Dekodierung mit Punktierung"
...
\end{equation*}
\vspace*{10mm}
- Depunktiertes Signal: (`r round(params$code, digits = 1)`)
...
## Trellis Diagram `r if(params$soft.flag) "(soft decision)" else "(hard decision)"`
