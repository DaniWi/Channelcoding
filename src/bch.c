...
void gen_poly(int* m_r, int* length_r, int* t_r, int* g, int* alpha_to, int* index_of, int* length_g, int* lm)
//gen_poly(int *m_r, int *length_r, int *t_r, int *g)
//gen_poly()
/*
...
*/
    ...
    /*int             p[21];
int             alpha_to[1048576], index_of[1048576];
int             recd[1000000], data[1000000], bb[500000];
int             seed;
...
*/
    ...
    register int ii, jj, ll, kaux, i, mask, ninf;
...
void 
encode_bch(int *length_r, int *lm, int *g, int *bb, int *recd, int *data)
/*
...
void decode_bch(int* m_r, int* length_r, int* t_r, int* alpha_to, int* index_of, int* recd, int* nBlocks, int* lm)
{
    int m, length, t, n;
    ...
    for (currentMsg = 0; currentMsg < (*nBlocks); currentMsg++) {
		 ...
		 */
            ...
            if (l[u] <= t) { /* Can correct errors */
                ...
                if (count == l[u])
                    ...
                    for (i = 0; i < l[u]; i++) {
                        recd[loc[i] + length*currentMsg] ^= 1;
                        loc[i] = 0;
                    }
